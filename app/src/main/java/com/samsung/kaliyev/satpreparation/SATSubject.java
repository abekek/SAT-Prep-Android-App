...
public class SATSubject extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_satsubject);
        ...
        mFirestore.collection("posts_s").addSnapshotListener(new EventListener<QuerySnapshot>() {
