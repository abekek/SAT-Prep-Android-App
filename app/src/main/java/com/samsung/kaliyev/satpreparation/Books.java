...
public class Books extends AppCompatActivity {
    ...
    private BooksListAdapter postsListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        postsListAdapter = new BooksListAdapter(getApplicationContext(), postsList);
        ...
        mFirestore.collection("books").addSnapshotListener(new EventListener<QuerySnapshot>() {
